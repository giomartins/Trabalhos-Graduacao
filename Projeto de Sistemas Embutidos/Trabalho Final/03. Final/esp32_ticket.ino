...
void dumpData(const struct quirc_data *data)
{
  ...
  HTTPClient http;
  http.begin("https://ticketauthenticatorufmg-096d21475c99.herokuapp.com/validar_ingresso/" + String(reinterpret_cast<const char*>(data->payload)));
  ...
  if (httpCode > 0) {
    if (httpCode == HTTP_CODE_OK) {
      ...
      DynamicJsonDocument doc(1024); // Tamanho máximo esperado do JSON
...
{
  if (result == "Ingresso já utilizado") {
